...
# MAGIC %md
# MAGIC ### Alternatively, load feature tables from the feature store
...
wine_feature_table = fs.read_table('crobison_wine_data.wine_features')

display(wine_feature_table)

# COMMAND ----------

# MAGIC %md
# MAGIC For now, let's continue with the dataframe we just created
